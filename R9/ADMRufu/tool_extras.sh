...
install_h(){
  ...
  msg -bar
  arq=$(curl -sSL https://raw.githubusercontent.com/jose7751/LORLACK001/main/R9/online/list-arq)
  mkdir ${ADM_src}/tool
  ...
  do
    ...
    if echo -ne $(msg -azu "  Descargando $line3....") && wget -O ${ADM_src}/tool/$line3 https://raw.githubusercontent.com/jose7751/LORLACK001/main/R9/online/$line3 &>/dev/null; then
